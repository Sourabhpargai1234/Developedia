    ...
    <div className="w-full h-auto p-8 bg-gray-100 text-gray-900">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg mb-6">
          Welcome to <span className="font-semibold">DevConnect</span>, the ultimate social platform built by developers, for developers!
        </p>
        ...
        <ul className="list-disc pl-6 mb-6">
          <li className="mb-2">
            <span className="font-semibold">Share Knowledge:</span> Whether it&rsquo;s a new coding technique, a blog post, or an open-source project, DevConnect is the place to share your ideas and get feedback from fellow developers.
          </li>
          <li className="mb-2">
